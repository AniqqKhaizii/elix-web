...
function Company() {
	...
	return (
		<div className="relative">
			<div className="sticky top-0 sm:h-[100vh] h-auto flex flex-col items-center justify-center bg-white py-12 mx-2">
			...
			<div className="sticky top-0 sm:mt-0 h-auto sm:h-[50vh] flex flex-col items-center justify-center bg-partner bg-[url('/background.webp')] bg-fixed bg-cover bg-no-repeat text-white">
					...
					<div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
						...
						<div className="grid lg:grid-cols-2 sm:grid-cols-1 gap-8 mt-8">
							<motion.div
								...
								whileInView="onscreen"
								variants={cardVariants}
								className="mt-8 flex flex-col gap-12 md:flex-row lg:flex-row justify-center items-center bg-white/90 backdrop-blur-md p-8 rounded-xl"
							>
								<img
